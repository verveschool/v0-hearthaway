...
export const additionalAccommodationProperties: CatalogProperty[] = [
  makeProperty({
    ...
    highlights: ['Opposite De Havilland campus', '15-minute walk to College Lane campus', 'Modern studios and two-bed apartments', 'Free on-site sports centre', 'Extensive resident social spaces'],
    roomFeatures: ['Private en-suite bathroom', 'Small double bed', 'Study area', 'Smart TV', 'Wardrobe', 'Private kitchen area in studios', 'Desk', 'Private bathroom'],
