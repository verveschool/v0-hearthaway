        ...
        <section className="bg-[#00319D] pt-28 pb-16 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="max-w-2xl">
              <div className="text-[#FCC20A] text-sm font-bold tracking-widest uppercase mb-4">Universities</div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <div className="relative flex-1 max-w-lg">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl border border-[#E8E6E1] bg-white text-sm text-[#1A1A1A] focus:outline-none focus:border-[#00319D] transition-colors"
                  ...
                  <button
                    ...
                    className={`px-4 py-2.5 rounded-xl border text-sm font-medium transition-all ${
                      f.value === selectedCountry
                        ? 'bg-[#00319D] border-[#00319D] text-white'
                        : 'bg-white border-[#E8E6E1] text-[#6B6860] hover:border-[#00319D]/40'
                    }`}
                ...
                filteredUniversities.map((uni) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <span className="text-xs font-bold tracking-wider uppercase text-[#00319D] bg-[#00319D]/8 px-2.5 py-1 rounded-full">
                        {uni.country}
                      </span>
                    </div>
...
export default function UniversitiesPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#00319D]" />}>
      <UniversitiesContent />
    </Suspense>
  )
}
