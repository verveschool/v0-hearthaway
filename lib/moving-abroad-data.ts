...
export type MovingAbroadCountrySlug = 'uk' | 'ireland' | 'france' | 'uae' | 'germany' | 'australia' | 'usa' | 'canada' | 'spain' | 'austria' | 'singapore' | 'malta' | 'italy' | 'netherlands' | 'malaysia'
...
export const movingAbroadArticles: MovingAbroadArticle[] = [
  {
    ...
    stage: 'Planning',
    countries: ['uk', 'ireland', 'australia', 'usa', 'canada', 'spain', 'austria', 'singapore', 'malta', 'italy', 'netherlands', 'malaysia'],
    sections: [
      {
  ...
  },
  {
    ...
    readTime: '8 min read',
    stage: 'Planning',
    countries: ['uk', 'ireland', 'australia', 'france', 'usa', 'canada', 'spain', 'austria', 'singapore', 'malta', 'italy', 'netherlands', 'malaysia'],
    sections: [
      {
...
export const countryMovingAbroadSlugs: Record<MovingAbroadCountrySlug, string[]> = {
  ...
  const movingAbroadCountrySlugs: MovingAbroadCountrySlug[] = ['uk', 'ireland', 'france', 'uae', 'germany', 'australia', 'usa', 'canada', 'spain', 'austria', 'singapore', 'malta', 'italy', 'netherlands', 'malaysia']
