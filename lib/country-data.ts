...
export const countries: CountryPlace[] = [
  ...
  },
  {
    ...
    citySlugs: ['new-york', 'boston', 'chicago'], universitySlugs: ['columbia', 'nyu', 'harvard', 'boston-university', 'chicago-university'],
  ...
  },
  {
    ...
    citySlugs: ['toronto', 'vancouver', 'montreal'], universitySlugs: ['toronto-university', 'york-university', 'ubc', 'mcgill'],
  ...
  },
  {
    ...
    citySlugs: ['madrid', 'barcelona', 'valencia'], universitySlugs: ['complutense-madrid', 'uab', 'valencia-university'],
  ...
  },
  {
    ...
    citySlugs: ['vienna', 'graz', 'innsbruck'], universitySlugs: ['vienna-university', 'tu-wien', 'graz-university', 'innsbruck-university'],
  ...
  },
  {
    ...
    citySlugs: ['singapore-city'], universitySlugs: ['nus', 'ntu'],
  ...
  },
  {
    ...
    citySlugs: ['valletta', 'msida'], universitySlugs: ['malta-university'],
  ...
  },
  {
    ...
    citySlugs: ['milan', 'rome', 'bologna'], universitySlugs: ['milan-university', 'sapienza', 'bologna-university'],
