import type { MovingAbroadArticleCard } from '@/lib/moving-abroad-data'
import { getCountryMovingAbroadLinks } from '@/lib/moving-abroad-data'
...
export const countries: CountryPlace[] = [
  {
    ...
    movingAbroadLinks: getCountryMovingAbroadLinks('uk'),
  },
  {
    name: 'Ireland',
    slug: 'ireland',
    ...
    movingAbroadLinks: getCountryMovingAbroadLinks('ireland'),
  },
  {
    name: 'Australia',
    slug: 'australia',
    ...
    movingAbroadLinks: getCountryMovingAbroadLinks('australia'),
  },
]
