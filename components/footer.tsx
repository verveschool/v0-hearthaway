...
export default function Footer() {
  return (
    <footer className="bg-[#1B365D] text-white">
      ...
      {/* Links Row — full-width flex, first column pinned left, last column pinned right,
          gaps between columns flex to fill whatever width remains. Columns keep their own
          natural width (flex-shrink-0) so only the gaps change, not the column widths. */}
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-16">
        <div className="flex flex-col sm:flex-row sm:flex-nowrap sm:items-start sm:justify-between gap-10 sm:gap-8 w-full">
          ...
          <div className="sm:flex-shrink-0">
            ...
            <div className="text-sm text-white/70 space-y-3 mb-6">
              ...
              <p>
                <a href="tel:+919999965742" className="hover:text-white underline whitespace-nowrap">
                  {"+91 99999 65742"}
                </a>
              </p>
