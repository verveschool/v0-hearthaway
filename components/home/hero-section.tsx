...
export default function HeroSection() {
  ...
  return (
    <section className="bg-white flex flex-col lg:flex-row items-center justify-between pt-10 lg:pt-12 pb-12 lg:pb-16 px-6 sm:px-10 lg:px-14 xl:px-20 gap-10 lg:gap-14 font-sans">
      ...
      <div className="relative z-10 flex flex-col justify-center w-full lg:w-[50%] max-w-2xl">
        ...
        <h1
          className="font-heading font-extrabold text-[#00319D] leading-[1.08] tracking-tight mb-6 text-balance"
          style={{ fontSize: 'clamp(2.6rem, 4.8vw, 4rem)' }}
        >
          Find the right accommodation
          <span className="block mt-1 text-[#FCC20A]">
            before you arrive.
          </span>
        </h1>

        <p
          className="text-[#00319D]/80 font-medium leading-relaxed mb-4 max-w-lg"
        ...
        <p
          className="text-[#00319D]/80 font-medium leading-relaxed mb-8 max-w-lg"
          style={{ fontSize: 'clamp(1rem, 1.6vw, 1.15rem)' }}
        >
      ...
      <div className="relative w-full lg:w-[45%] aspect-[4/3] lg:aspect-[4/5] max-h-[500px] overflow-hidden rounded-3xl shadow-2xl border border-[#00319D]/10">
        ...
        {photos.map((photo, i) => (
          ...
          >
            ...
            {/* subtle neutral gradient for image controls */}
        ...
        <div className="absolute bottom-6 left-6 right-6 z-10 flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="w-8 h-8 flex items-center justify-center rounded-full bg-black/25 border border-white/40 text-white hover:bg-black/45 hover:scale-105 transition-all backdrop-blur-md"
            >
