...
export default function TrustStatsSection() {
  return (
    <section className="bg-[#00319D] border-t border-white/8" aria-labelledby="trust-stats-heading">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat) => (
            <div key={stat.label} className="text-center">
              <div className="text-[#FCC20A] font-extrabold text-3xl lg:text-4xl mb-2">{stat.value}</div>
