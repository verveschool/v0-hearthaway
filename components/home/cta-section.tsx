  ...
  return (
    <section className="bg-[#F7F6F3] py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#1B365D] via-[#1B365D] to-[#122542] min-h-[480px] flex flex-col lg:flex-row">
          ...
          <div className="relative z-10 flex-1 flex flex-col justify-center p-10 lg:p-16 xl:p-20">
            ...
            <h2 className="font-heading text-4xl lg:text-[3rem] xl:text-[3.5rem] font-extrabold text-white leading-[1.08] tracking-tight text-balance mb-6 max-w-xl">
              ...
              <span className="text-[#F2B705]">Now get your home.</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <Link
                href="/get-matched"
                className="inline-flex items-center justify-center gap-3 px-8 py-5 bg-[#F2B705] text-[#1B365D] font-extrabold text-lg rounded-xl hover:bg-[#D9A404] transition-colors shadow-xl"
              >
              ...
              {[
                ...
                <span key={item} className="flex items-center gap-2">
                  <svg width="13" height="13" viewBox="0 0 14 14" fill="none" aria-hidden="true">
                    <path d="M2 7L5.5 10.5L12 4" stroke="#F2B705" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                  {item}
                </span>
              ))}
          ...
          <div className="relative lg:w-[45%] h-64 lg:h-auto overflow-hidden flex-shrink-0 rounded-b-3xl lg:rounded-r-3xl lg:rounded-bl-none">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[#1B365D]/90 via-[#1B365D]/40 to-transparent lg:block hidden" />
            <div className="absolute inset-0 bg-gradient-to-t from-[#1B365D]/70 via-[#1B365D]/30 to-transparent lg:hidden" />
