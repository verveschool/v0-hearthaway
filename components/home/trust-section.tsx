...
export default function TrustSection() {
  return (
    <section className="bg-[#00319D] py-24 lg:py-32">
          ...
          {testimonials.map((t) => (
            <div key={t.name} className="flex flex-col bg-white rounded-2xl overflow-hidden">
              ...
              <div className="relative h-40 overflow-hidden flex-shrink-0">
                ...
                />
                <div className="absolute inset-0 bg-[#00319D]/50" />
              ...
              <div className="flex flex-col flex-1 p-7">
                ...
                <div className="flex gap-0.5 mb-5" aria-label="5 out of 5 stars">
                  {[...Array(5)].map((_, j) => (
                    <svg key={j} width="15" height="15" viewBox="0 0 16 16" fill="#FCC20A" aria-hidden="true">
                ...
                <div className="pt-5 border-t border-[#E8E6E1] flex items-center justify-between">
                  ...
                  <div className="w-8 h-8 rounded-full bg-[#00319D]/8 flex items-center justify-center">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={item.heading} className="text-center lg:text-left">
                <div className="w-8 h-8 rounded-lg bg-[#FCC20A]/15 border border-[#FCC20A]/25 flex items-center justify-center mb-4 mx-auto lg:mx-0">
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
